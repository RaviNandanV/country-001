...
let displayWeather = (weatherInfo,id) => {
  ...
  let modelpop = document.querySelector(".fullmodel");
  modelpop.innerHTML=""
  let modelbody = "";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close closeModel" data-dismiss="modal" aria-label="Close" onclick="closeModel()">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary closeModel" data-dismiss="modal" onclick="closeModel()">Close</button>
      </div>
    </div>
  </div>
  </div>`;
...
let closeModel=()=>{
    ...
    document.querySelector(".fullmodel").innerHTML=""
}
contrylist();
